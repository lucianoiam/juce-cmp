...
// Direct IOSurface framework calls
private interface IOSurfaceLib : Library {
...
fun runIOSurfaceRenderer(surfaceID: Int, content: @Composable () -> Unit) {
    println("Looking up IOSurface ID $surfaceID...")
